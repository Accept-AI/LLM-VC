...
# save test pictures
train_path = "/home/xzy/xzy_nba/VG_NBA_data_train/"
...
for k_vid, v_vid in result_info.items():
    ...
    if game_id in train_game_list:
        if video_id not in train_video_dict:
            ...
            video_save_path = os.path.join(train_video_path, game_id, video_id)
            ...
            pictures_path = os.path.join(train_path, video_id)  # out path
...
train_video_file.write(json_save)
train_video_file.close()
