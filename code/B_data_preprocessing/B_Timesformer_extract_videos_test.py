...
def main(file_path):
    ...
    """Read mp4 files"""
    mp4_path = os.path.join("/home/xzy/xzy_nba/VG_NBA_videos_test", file_path)
...
if __name__ == "__main__":
    vid_folders = os.listdir("/home/xzy/xzy_nba/VG_NBA_videos_test")
    print(vid_folders)
