...
def read_dataset(args):
    ...
    # return train_set, test_set
        ...
        test_data = nba_read_test_annotations(image_path, test_ids)
        test_frames = nba_all_frames(test_data)

        train_set = NBA2022(train_frames, train_data, image_2022_path, args, is_training=True)
        test_set = NBADataset(test_frames, test_data, image_path, args, is_training=False)
    else:
        assert False
